...
Basebook is the first social NFT launchpad on Base. It has been built with the [Iggy](https://iggy.social/) web3 framework. It uses [Orbis SDK](https://github.com/OrbisWeb3/orbis-sdk) and Ceramic Network in the background.
